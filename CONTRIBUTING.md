...
The current production line is `1.0.4`; patch releases should continue from that line. Reserve `2.0.0` for the future major redesign when the new UI is ready. Follow [`RELEASE_CHECKLIST.md`](RELEASE_CHECKLIST.md) for the version bump, promotion, tag, draft-release review, and later signing/publishing steps.
