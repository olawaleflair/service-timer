...
- [ ] Verify the expected macOS DMG and Windows MSI/NSIS files plus the embedded SHA-256 manifest; run checksum verification from the downloaded artifact root.
...
- [ ] Only after the version change is on GitHub `main`, create the exact matching tag (for example, `v2.0.1`).
